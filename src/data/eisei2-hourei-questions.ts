...
export const EISEI2_HOUREI_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      "就業規則は法令より優先する",
      "就業規則は労働協約より優先する",
      "法令または労働協約に反する就業規則は、その部分について効力を有しない",
    ],
    answer: 3,
    explain:
  ...
  },
  {
    ...
    choices: [
      "年10日まで時間単位で与えられる",
      "労使協定がなくても時間単位で与えられる",
      "労使協定を締結すれば、年5日を限度として時間単位で与えることができる",
      "時間単位付与の制度はない",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    choices: [
      "事業者に代わって衛生管理者を選任できる",
      "労働者を直接解雇することができる",
      "事業場に臨検し、帳簿・書類の提出を求め、関係者に尋問することができる",
      "労働条件を直接決定できる",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    choices: [
      ...
      "規程は不要である",
      "情報は自由に共有してよい",
      "取扱いに関する規程を定め、労働者に周知したうえで適正に運用する",
    ],
    answer: 3,
    explain:
  ...
  },
  {
    ...
    choices: [
      ...
      "常時床面積の10分の1以上",
      "常時床面積の30分の1以上",
      "常時床面積の20分の1以上を直接外気に向かって開放できること",
    ],
    answer: 3,
    explain:
  ...
  },
  {
    ...
    choices: [
      "医薬品はすべて備える必要がある",
      "救急用具の備付けは任意である",
      "負傷者の手当に必要な用具・材料を備え、その備付け場所と使用方法を労働者に周知する",
  ...
  },
  {
    ...
    choices: [
      ...
      "専任はその職務にもっぱら従事すること、専属はその事業場にのみ所属することをいう",
    ],
    answer: 3,
    explain:
  ...
  },
  {
    ...
    choices: [
      "記録だけして特に何もしない",
      "次回の衛生委員会まで待って報告する",
      "直ちに必要な措置を講じ、あわせて事業者に報告して恒久的な改善につなげる",
  ...
  },
  {
    ...
    choices: [
      ...
      "後任の選任は任意である",
      "1年以内に後任を選任すればよい",
      "遅滞なくその旨と理由を衛生委員会に報告し、14日以内に後任を選任する",
    ],
    answer: 3,
    explain:
