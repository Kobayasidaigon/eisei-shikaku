...
export const EISEI1_EISEI_YUGAI_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      "A測定は単位作業場所の平均的分布、B測定は発生源に近接した最高濃度を把握する",
      "A測定とB測定は同じ内容の測定である",
      "B測定は屋外作業場でのみ行う",
    ],
    answer: 1,
