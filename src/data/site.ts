...
export const SITE = {
  ...
  tagline: "第二種衛生管理者の無料練習問題・模擬試験",
  // 本番: シカクモンのサブドメイン(新規ドメイン購入なし)
  url: "https://eisei.shikakumon.com",
  description: `第二種衛生管理者試験の無料練習問題サイト。関係法令・労働衛生・労働生理の3科目を解説つき4択で演習でき、本番形式モードや模擬試験で合格ライン判定もできます。全${CERTS.length}試験・全${QUESTIONS.length}問。`,
  // シカクモン関連リンク
...
export const AUTHOR = {
  ...
  description:
    "公式の試験範囲にもとづき、第二種衛生管理者の練習問題と解説を作成し、独立した検証を経て公開しています。特定の実務資格の保有を主張するものではなく、出典を示した学習用の教材として提供します。",
};
