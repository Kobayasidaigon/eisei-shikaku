...
export const EISEI2_EISEI_QUESTIONS: Question[] = [
  ...
  // ---- 温熱・換気(細目) ----
  {
    id: "eisei2-eisei-151",
    category: "e2-eisei",
    q: "屋内におけるWBGT(暑さ指数)の算出に用いる測定値の組合せとして、正しいものはどれか。",
    choices: [
      "自然湿球温度と黒球温度",
      "乾球温度と気流速度",
      "乾球温度と気圧",
  ...
  },
  {
    id: "eisei2-eisei-152",
    category: "e2-eisei",
    q: "機械換気のうち、給気・排気の両方を送風機で行う方式を何というか。",
    choices: ["第1種機械換気", "第2種機械換気", "第3種機械換気", "自然換気"],
    answer: 0,
    explain:
  ...
  },
  {
    id: "eisei2-eisei-153",
    category: "e2-eisei",
    q: "室内空気を汚染する物質のうち、建材や接着剤から発生し、シックハウス症候群の原因となるものはどれか。",
    choices: ["ホルムアルデヒド", "窒素", "アルゴン", "ヘリウム"],
    answer: 0,
    explain:
  ...
  },
  {
    id: "eisei2-eisei-154",
    category: "e2-eisei",
    q: "気流の測定に用いられる器具として、適切なものはどれか。",
    choices: ["カタ温度計や熱線風速計", "黒球温度計", "アスマン通風乾湿計", "オージオメータ"],
    answer: 0,
    explain:
  ...
  // ---- 食中毒・感染症(細目) ----
  {
    id: "eisei2-eisei-155",
    category: "e2-eisei",
    q: "セレウス菌による食中毒に関する次の記述のうち、正しいものはどれか。",
    choices: [
      "米飯やめん類などでみられ、嘔吐型と下痢型がある",
      "海産魚介類のみが原因となる",
      "冬季のウイルス性食中毒である",
      "自然毒による食中毒である",
    ],
  ...
  },
  {
    id: "eisei2-eisei-156",
    category: "e2-eisei",
    q: "アニサキスによる食中毒(食品衛生上の健康被害)の原因と予防法として、正しいものはどれか。",
    choices: [
      "サバ・イカなどの生食が原因で、冷凍または十分な加熱により予防できる",
      "細菌が産生する毒素が原因である",
      "食酢や塩漬けで確実に死滅する",
      "加熱しても予防できない",
    ],
  ...
  },
  {
    id: "eisei2-eisei-157",
    category: "e2-eisei",
    q: "感染性胃腸炎が事業場で集団発生した場合の初動対応として、適切でないものはどれか。",
    choices: [
      "原因が判明するまで、嘔吐物はそのままにしておく",
      "有症者を就業から離し、医療機関の受診を勧める",
      "嘔吐物は使い捨て手袋・マスクを用い、飛散しないよう処理して次亜塩素酸ナトリウムで消毒する",
      "手洗いの徹底を周知し、保健所等に相談する",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    id: "eisei2-eisei-158",
    category: "e2-eisei",
    q: "インフルエンザの職場での感染拡大防止策として、適切でないものはどれか。",
    choices: [
      "発熱があっても軽症であれば通常どおり出勤させる",
      "咳エチケットと手洗いを周知する",
      "室内の適度な湿度を保ち、換気を行う",
      "予防接種の機会を提供する",
    ],
  ...
  // ---- 統計・評価(細目) ----
  {
    id: "eisei2-eisei-159",
    category: "e2-eisei",
    q: "在籍労働者の延所定労働日数が20,000日、疾病休業延日数が100日であった場合の疾病休業日数率はいくらか。",
    choices: ["0.5", "5.0", "0.05", "50"],
    answer: 0,
    explain:
  ...
  },
  {
    id: "eisei2-eisei-160",
    category: "e2-eisei",
    q: "労働災害統計における「労働損失日数」の考え方として、正しいものはどれか。",
    choices: [
      "死亡や身体障害が残った場合、障害等級に応じて定められた日数に換算する",
      "実際に休業した日数のみを数える",
      "死亡の場合は0日として扱う",
      "損失日数という概念はない",
    ],
  ...
  },
  {
    id: "eisei2-eisei-161",
    category: "e2-eisei",
    q: "健康診断のスクリーニングにおける「カットオフ値(スクリーニングレベル)」の設定について、労働衛生上の考え方として正しいものはどれか。",
    choices: [
      "見落とし(偽陰性)を減らすことを重視し、低めに設定する",
      "偽陽性を減らすことを重視し、高めに設定する",
      "設定値は結果に影響しない",
      "医師が個別に自由に決める",
    ],
    answer: 0,
  ...
  },
  {
    id: "eisei2-eisei-162",
    category: "e2-eisei",
    q: "健康診断データの分析において、集団の分布を把握するために有用な指標の組合せとして正しいものはどれか。",
    choices: [
      "平均値・中央値・標準偏差",
      "度数率・強度率・年千人率",
      "気温・湿度・気流",
  ...
  },
  {
    id: "eisei2-eisei-164",
    category: "e2-eisei",
    q: "頭部を強く打った傷病者への対応として、適切でないものはどれか。",
    choices: [
      "意識がはっきりしていれば、そのまま作業を継続させる",
      "意識状態・嘔吐・けいれんの有無などを観察する",
      "受傷直後に異常がなくても、しばらく経過を観察する",
      "意識障害や繰り返す嘔吐があれば直ちに救急要請する",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    id: "eisei2-eisei-165",
    category: "e2-eisei",
    q: "化学熱傷(薬傷)の応急手当として、最も適切なものはどれか。",
    choices: [
      "付着した衣類を取り除き、直ちに大量の流水で長時間洗い流す",
      "中和剤をかけて反応させる",
      "そのまま医療機関へ搬送する",
      "軟膏を塗ってから包帯を巻く",
    ],
  ...
  },
  {
    id: "eisei2-eisei-166",
    category: "e2-eisei",
    q: "傷病者の搬送に関する次の記述のうち、適切なものはどれか。",
    choices: [
      "傷病の状態に応じた体位をとらせ、できるだけ振動を与えないように搬送する",
      "できるだけ速く走って搬送する",
      "常に座位で搬送する",
      "搬送中の観察は不要である",
    ],
  ...
  },
  {
    id: "eisei2-eisei-167",
    category: "e2-eisei",
    q: "低体温症が疑われる傷病者への対応として、適切なものはどれか。",
    choices: [
      "濡れた衣服を取り除き、毛布などで保温しながら医療機関へ搬送する",
      "熱い湯に浸けて急速に加温する",
      "アルコールを飲ませて体を温める",
      "屋外で安静にさせる",
    ],
  ...
  // ---- 情報機器作業・作業管理(細目) ----
  {
    id: "eisei2-eisei-168",
    category: "e2-eisei",
    q: "情報機器作業のガイドラインにおける作業区分の考え方として、正しいものはどれか。",
    choices: [
      "作業時間や作業の拘束性などに応じて区分し、区分に応じた健康管理を行う",
      "すべての作業者を一律に扱う",
      "年齢のみで区分する",
      "職位で区分する",
    ],
  ...
  },
  {
    id: "eisei2-eisei-169",
    category: "e2-eisei",
    q: "情報機器作業による健康影響として、典型的でないものはどれか。",
    choices: ["じん肺", "眼精疲労やドライアイ", "頸肩腕部の痛みやこり", "精神的ストレス"],
    answer: 0,
    explain:
  ...
  },
  {
    id: "eisei2-eisei-170",
    category: "e2-eisei",
    q: "職場の照明設備の保守について、適切なものはどれか。",
    choices: [
      "ランプや反射板の汚れ、ランプの劣化により照度が低下するため、定期的に清掃・交換する",
      "設置すれば保守は不要である",
      "照度は経年変化しない",
      "ランプが切れてから交換すれば十分である",
    ],
  ...
  },
  {
    id: "eisei2-eisei-171",
    category: "e2-eisei",
    q: "座り作業における腰痛予防の観点から、適切な椅子の条件として正しいものはどれか。",
    choices: [
      "座面の高さが調節でき、背もたれで腰部を支えられること",
      "座面が高く固定されていること",
      "背もたれがないこと",
      "キャスターが動かないよう固定されていること",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    id: "eisei2-eisei-172",
    category: "e2-eisei",
    q: "高年齢労働者に多い労働災害の型として、特に注意すべきものはどれか。",
    choices: ["転倒および墜落・転落", "感電", "有機溶剤中毒", "騒音性難聴"],
    answer: 0,
    explain:
  ...
  // ---- メンタルヘルス・健康保持増進(細目) ----
  {
    id: "eisei2-eisei-173",
    category: "e2-eisei",
    q: "メンタルヘルスケアにおける「事業場外資源」の例として、適切なものはどれか。",
    choices: [
      "地域産業保健センター、外部のEAP機関、医療機関",
      "社内の衛生管理者",
      "社内の産業医",
      "直属の上司",
    ],
  ...
  },
  {
    id: "eisei2-eisei-174",
    category: "e2-eisei",
    q: "ストレスチェックの結果を活用した職場環境の改善について、適切なものはどれか。",
    choices: [
      "集団分析の結果をもとに、業務量の偏りやコミュニケーションなど職場側の要因を検討する",
      "高ストレス者個人の問題として処理する",
      "結果は改善に用いない",
      "分析結果は個人名とともに公表する",
    ],
  ...
  },
  {
    id: "eisei2-eisei-175",
    category: "e2-eisei",
    q: "健康保持増進措置における「運動指導」の進め方として、適切なものはどれか。",
    choices: [
      "健康測定の結果に基づき、個々の労働者の状態に応じた運動プログラムを作成する",
      "全員に同じ強度の運動を課す",
      "運動指導は健康な人だけに行う",
      "運動指導の効果は評価しない",
    ],
  ...
  },
  {
    id: "eisei2-eisei-176",
    category: "e2-eisei",
    q: "治療と仕事の両立支援を進める際の手順として、最初に行うべきことはどれか。",
    choices: [
      "労働者本人からの申出を受け、業務内容や勤務状況に関する情報を整理する",
      "主治医に直接連絡して病状を確認する",
      "直ちに配置転換を決定する",
      "産業医の判断のみで就業制限を決める",
    ],
  ...
  },
  {
    id: "eisei2-eisei-177",
    category: "e2-eisei",
    q: "受動喫煙防止対策における屋外での配慮として、適切なものはどれか。",
    choices: [
      "喫煙場所は、施設の出入口や人が多く通行する場所から離れた位置に設ける",
      "屋外であれば場所を問わない",
      "出入口付近に設けるのがよい",
      "屋外での配慮は不要である",
    ],
  ...
  // ---- 総合・応用 ----
  {
    id: "eisei2-eisei-178",
    category: "e2-eisei",
    q: "職場における労働衛生対策を検討する順序として、最も適切なものはどれか。",
    choices: [
      "有害要因の把握 → リスクの評価 → 対策の検討と実施 → 効果の確認",
      "対策の実施 → 有害要因の把握 → 効果の確認",
      "効果の確認 → 対策の実施 → リスクの評価",
      "順序に決まりはない",
    ],
  ...
  },
  {
    id: "eisei2-eisei-179",
    category: "e2-eisei",
    q: "作業環境の「明るさ」に関する管理として、適切でないものはどれか。",
    choices: [
      "作業面の照度が高ければ高いほどよいので、可能な限り明るくする",
      "作業の種類に応じた適切な照度を確保する",
      "視野内の輝度の差を小さくする",
      "グレア(まぶしさ)を防ぐ",
    ],
  ...
  },
  {
    id: "eisei2-eisei-180",
    category: "e2-eisei",
    q: "労働衛生管理における「健康管理」の内容として、適切でないものはどれか。",
    choices: [
      "局所排気装置を設置して有害物の発散を防ぐこと",
      "健康診断を実施し、結果に基づく事後措置を行うこと",
      "健康相談や保健指導を行うこと",
      "健康の保持増進のための取組を行うこと",
    ],
    answer: 0,
  ...
  },
  {
    id: "eisei2-eisei-181",
    category: "e2-eisei",
    q: "職場における感染症対策として、「感染経路対策」に該当するものはどれか。",
    choices: [
      "手洗い・手指消毒の徹底、換気、マスクの着用",
      "予防接種の実施",
      "十分な休養と栄養の確保",
      "有症者の早期発見と隔離",
    ],
  ...
  },
  {
    id: "eisei2-eisei-182",
    category: "e2-eisei",
    q: "職場の休養設備に関する考え方として、適切なものはどれか。",
    choices: [
      "疲労回復のため、労働者が横になれる休養室等を必要に応じて設ける",
      "休憩は自席でとらせれば十分である",
      "休養設備は法令上まったく求められていない",
      "休養室は男女共用でよい",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    id: "eisei2-eisei-183",
    category: "e2-eisei",
    q: "熱中症の予防のための「作業要因」への対策として、適切なものはどれか。",
    choices: [
      "作業時間の短縮、休憩の頻回化、通気性のよい服装の採用",
      "気温・湿度の測定",
      "労働者の睡眠状況の確認",
      "健康診断の実施",
    ],
  ...
  },
  {
    id: "eisei2-eisei-184",
    category: "e2-eisei",
    q: "労働衛生教育の効果を高める工夫として、適切でないものはどれか。",
    choices: [
      "一度に大量の内容を詰め込み、以後は実施しない",
      "実際の作業や職場の事例に即した内容とする",
      "討議やグループワークなど参加型の方法を取り入れる",
      "定期的に繰り返し実施する",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    id: "eisei2-eisei-185",
    category: "e2-eisei",
    q: "職場巡視を効果的に行うための工夫として、適切でないものはどれか。",
    choices: [
      "毎回同じ時間帯・同じ経路のみを巡視する",
      "チェックリストを用いて確認漏れを防ぐ",
      "作業者に声をかけ、実際の困りごとを聞き取る",
      "指摘事項を記録し、改善状況を次回確認する",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    id: "eisei2-eisei-186",
    category: "e2-eisei",
    q: "労働衛生における「有害要因」の分類として、化学的要因に該当するものはどれか。",
    choices: ["有機溶剤や粉じん", "騒音や振動", "細菌やウイルス", "作業姿勢や作業時間"],
    answer: 0,
    explain:
  ...
  },
  {
    id: "eisei2-eisei-187",
    category: "e2-eisei",
    q: "作業に関連して起こる健康障害のうち、人間工学的要因によるものはどれか。",
    choices: ["腰痛や頸肩腕障害", "じん肺", "騒音性難聴", "有機溶剤中毒"],
    answer: 0,
    explain:
  ...
  },
  {
    id: "eisei2-eisei-188",
    category: "e2-eisei",
    q: "「疲労」と「作業能率」の関係について、正しいものはどれか。",
    choices: [
      "疲労が蓄積すると作業能率が低下し、事故やミスが増える傾向がある",
      "疲労と作業能率は無関係である",
      "疲労が蓄積するほど作業能率は向上する",
      "作業能率は疲労の指標にならない",
    ],
  ...
  },
  {
    id: "eisei2-eisei-189",
    category: "e2-eisei",
    q: "職場における飲料水の管理として、適切なものはどれか。",
    choices: [
      "水質基準に適合する水を供給し、貯水槽等を用いる場合は定期的な清掃・点検を行う",
      "見た目がきれいであれば検査は不要である",
      "井戸水はそのまま使用してよい",
      "給水設備の管理は不要である",
    ],
  ...
  },
  {
    id: "eisei2-eisei-190",
    category: "e2-eisei",
    q: "労働衛生管理の成果を評価する方法として、適切でないものはどれか。",
    choices: [
      "衛生委員会の開催回数のみで評価する",
      "健康診断の有所見率の推移を確認する",
      "作業環境測定の管理区分の変化を確認する",
      "労働災害・疾病休業の統計の推移を確認する",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    id: "eisei2-eisei-191",
    category: "e2-eisei",
    q: "職場での応急手当を行う体制づくりとして、適切なものはどれか。",
    choices: [
      "救急用具の備付けと、応急手当ができる者の養成・救急連絡体制の整備を行う",
      "救急車を呼べば十分なので体制整備は不要である",
      "衛生管理者だけが応急手当を学べばよい",
      "応急手当は医療行為なので職場では一切行わない",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    id: "eisei2-eisei-192",
    category: "e2-eisei",
    q: "健康診断の結果、要精密検査とされた労働者への対応として、適切なものはどれか。",
    choices: [
      "受診を勧奨し、結果を踏まえて必要な就業上の措置を検討する",
      "本人任せにして特に関与しない",
      "直ちに就業を禁止する",
      "所轄労働基準監督署長に報告する",
    ],
  ...
  },
  {
    id: "eisei2-eisei-193",
    category: "e2-eisei",
    q: "衛生委員会で議題とすることが適切なテーマはどれか。",
    choices: [
      "職場巡視で判明した照度不足や換気の問題とその改善策",
      "個々の労働者の人事評価",
      "取引先との価格交渉",
      "特定の労働者の病名と治療内容",
    ],
  ...
  },
  {
    id: "eisei2-eisei-194",
    category: "e2-eisei",
    q: "「作業環境測定」「健康診断」「職場巡視」の関係として、最も適切なものはどれか。",
    choices: [
      "それぞれ異なる角度から職場の問題を把握する手段であり、結果を突き合わせて対策を立てる",
      "いずれか一つを行えば十分である",
      "三者はまったく無関係である",
      "職場巡視だけで作業環境測定を代替できる",
    ],
  ...
  },
  {
    id: "eisei2-eisei-195",
    category: "e2-eisei",
    q: "長時間労働による健康障害として、特に注意すべきものはどれか。",
    choices: [
      "脳・心臓疾患およびメンタルヘルス不調",
      "じん肺",
      "騒音性難聴",
  ...
  },
  {
    id: "eisei2-eisei-196",
    category: "e2-eisei",
    q: "職場における健康情報の第三者提供について、適切なものはどれか。",
    choices: [
      "原則として本人の同意を得たうえで、必要最小限の範囲で行う",
      "業務上必要であれば同意なく提供してよい",
      "上司には自由に提供してよい",
      "提供してはならない",
    ],
  ...
  },
  {
    id: "eisei2-eisei-197",
    category: "e2-eisei",
    q: "職場環境の改善提案を実現につなげるための工夫として、適切なものはどれか。",
    choices: [
      "改善による効果や必要な費用を整理し、衛生委員会を通じて事業者に提案する",
      "衛生管理者が独断で設備を発注する",
      "提案せずに現場で我慢する",
      "労働者の意見は聞かずに進める",
    ],
  ...
  },
  {
    id: "eisei2-eisei-198",
    category: "e2-eisei",
    q: "作業環境における温度・湿度の管理について、適切なものはどれか。",
    choices: [
      "季節や作業内容に応じて調整し、体感の個人差にも配慮する",
      "年間を通じて同じ設定とする",
      "温度のみを管理すれば十分である",
      "個人差は考慮しない",
    ],
  ...
  },
  {
    id: "eisei2-eisei-199",
    category: "e2-eisei",
    q: "労働衛生の観点から、新入社員に対して特に重点的に行うべきことはどれか。",
    choices: [
      "雇入れ時教育により、職場の危険・有害要因と対処方法を具体的に伝える",
      "教育は業務に慣れてから行う",
      "教育は不要である",
      "健康診断のみ行えばよい",
    ],
  ...
  },
  {
    id: "eisei2-eisei-200",
    category: "e2-eisei",
    q: "労働衛生管理を継続的に改善していくための考え方として、最も適切なものはどれか。",
    choices: [
      "計画・実施・評価・改善のサイクルを回し、結果を次の計画に反映させる",
      "一度対策を実施すれば見直しは不要である",
      "問題が起きてから対応すればよい",
      "他社の事例をそのまま導入すればよい",
    ],
