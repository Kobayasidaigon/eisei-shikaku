...
export const EISEI2_EISEI_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      "疾病休業日数率は、疾病休業延日数を延所定労働日数で割って100を掛けて求める",
  ...
  },
  {
    ...
    choices: [
      ...
      "気流に関する要件はない",
      "出入口において室外から室内に流入する気流が0.2m/s以上であること",
    ],
    answer: 3,
    explain:
  ...
  },
  {
    ...
    choices: [
      ...
      "ディスプレイ画面と書類面、周辺の明るさの差は、小さくするのがよい",
      "作業面だけを極端に明るくするのがよい",
      "周辺を暗くするほど目が疲れにくい",
    ],
    answer: 1,
