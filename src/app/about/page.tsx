    ...
    <div className="fade-up">
      ...
      <section className="mb-8">
        ...
        <p className="mt-3 text-[13px] text-ink leading-relaxed">
          {SITE.name}は、第一種・第二種衛生管理者試験に対応した、全{QUESTIONS.length}
          問の無料練習問題サイトです。共通3科目(関係法令・労働衛生・労働生理／いずれも有害業務以外)に、第一種の有害業務2科目を加えて収録しています。すべての問題に解説を付け、本番形式モード(本試験相当数をランダム出題・合格ライン判定)と模擬試験を用意しています。
      ...
      <section className="mb-8">
        ...
        <ul className="mt-3 space-y-2">
          {[
            "問題と解説は、公式の出題範囲と一般的な労働衛生の知識(関係法令・労働衛生・労働生理、および有害業務に係る法令・労働衛生)にもとづいて作成し、公開前に全問の構造チェックと独立したファクトチェックを通しています。",
